...
public abstract class AbstractMapInteractiveEntity : MapSprite
{
	...
	protected override void Update()
	{
		...
		Check();
		if (state == State.Activated || MapConfirmStartUI.Current.CurrentState != 0 || MapDifficultySelectStartUI.Current.CurrentState != 0 || MapEventNotification.Current.showing)
		{
			return;
		}
		switch (interactor)
	...
	{
		if (Map.Current.players[i] == null || Map.Current.players[i].state != 0)
		{
			return false;
		}
