...
public class FlyingBirdLevelSmallBird : LevelProperties.FlyingBird.Entity
{
	...
	private IEnumerator moveY_cr()
	{
		if (Rand.Bool())
		{
			...
			float time = base.properties.CurrentState.smallBird.timeY - currentDist / normalDist2;
		...
		else
		{
			...
			yield return StartCoroutine(tweenY_cr(time: base.properties.CurrentState.smallBird.timeY - currentDist2 / normalDist, start: base.transform.position.y, end: -230f, ease: EaseUtils.EaseType.easeInOutSine));
